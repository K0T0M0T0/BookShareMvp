...
import { approveBookOnServer, rejectBookOnServer } from "../../../store/Slices/booksSlice";
import styles from "../../../styles/components/admin/RequestsPage.module.scss";
import { useAppDispatch, useAppSelector } from "../../../app/hooks";

export default function RequestsPage() {
  const dispatch = useAppDispatch();
  const books = useAppSelector((s) => s.books);
  const adminId = useAppSelector((s) => s.session.userId) ?? undefined;
